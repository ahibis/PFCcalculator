<template>
  ...
  <v-row>
    ...
    <v-col>
      <v-btn icon color="blue" @click="lastDay()"><v-icon>mdi-minus</v-icon></v-btn>
      <v-btn icon color="blue" @click="nextDay()"><v-icon>mdi-plus</v-icon></v-btn>
    </v-col>
...
export default {
  ...
  methods:{
    addProduct(){
      ...
      if(this.dayProducts.find(e=>e.name==name))
        return
